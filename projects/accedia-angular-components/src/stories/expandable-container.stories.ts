...
const meta: Meta<ExpandableContainerComponent> = {
    ...
    render: (args) => {
        ...
        return {
            ...
            <div [ngStyle]="{ display: 'flex', 'align-items' : 'center', border: '1px solid var(--primary-color-red)', width: '200px', padding: '5px', 'border-radius' : '5px' }"><span>Click arrow to expand</span> <acc-expandable-arrow></acc-expandable-arrow></div>
